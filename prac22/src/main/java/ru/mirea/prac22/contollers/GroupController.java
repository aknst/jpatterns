...
public class GroupController {
  ...
  public ResponseEntity<?> createGroup(@RequestBody GroupDto groupDto) {
    try {
      ...
      return ResponseEntity.created(URI.create(String.format("/v1/group/%s", id.toString())))
          .build();
